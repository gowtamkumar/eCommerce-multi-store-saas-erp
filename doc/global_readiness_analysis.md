...
**Project:** eCommerce Multi-Store SaaS ERP  
...
This report analyzes the global market readiness of the modular monolith eCommerce SaaS ERP. The system currently features robust store isolation, ledger-based GAAP compliance, and modular domain design. However, its business-logic integrations, onboarding flows, and configurations are tightly coupled with the local market context (primarily Bangladesh, e.g., default `BDT` currency, local couriers Pathao/Steadfast, local gateway SSLCommerz, and hardcoded tax lists). 
...
### A. System Store & Onboarding Module
*   **Location:** [server/src/modules/system/store/](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/system/store/)
*   **Current Limitations:**
    *   Onboarding (`store.service.ts`) initializes all stores with standard Bangladesh-specific templates (defaulting to the same hardcoded [DEFAULT_CHART_OF_ACCOUNTS](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/admin/operations/finance/accounting/constants/default-coa.ts) and site settings).
...
*   **Global Enhancements Needed:**
    *   Expand `CreateStoreDto` to collect `baseCurrency`, `timezone`, `country`, and `accountingStandard`.
    ...
    *   Support dynamic database routing for stores requesting residency in specific regions (e.g., EU servers for German merchants to satisfy GDPR residency rules).

### B. Catalog & Pricing Module
*   **Location:** [server/src/modules/admin/catalog/](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/admin/catalog/)
*   **Current Limitations:**
...
*   **Location:** [server/src/modules/admin/sales/](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/admin/sales/)
*   **Current Limitations:**
...
*   **Location:** [server/src/modules/admin/operations/logistics/](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/admin/operations/logistics/)
*   **Current Limitations:**
...
*   **Location:** [server/src/modules/admin/operations/finance/](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/admin/operations/finance/)
*   **Current Limitations:**
...
*   **Location:** [server/src/modules/admin/settings/](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/server/src/modules/admin/settings/) & [client/hooks/SettingsContext.tsx](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/client/hooks/SettingsContext.tsx)
*   **Current Limitations:**
    *   The settings config ([defaultSettings.ts](file:///home/gowtamkumar/projects/eCommerce-multi-store-saas-erp/client/services/defaultSettings.ts)) defines local defaults (e.g., BDT currency and Dhaka timezone).
*   **Global Enhancements Needed:**
...
| :--- | :--- | :--- | :--- |
| **Phase 1** | **Onboarding & Configuration Foundation** | Expand onboarding variables, dynamic COA seeding, and regional setting initializations. | `Store`, `Settings` |
