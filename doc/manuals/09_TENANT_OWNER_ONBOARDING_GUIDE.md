# 🏁 Tenant Owner Onboarding Manual

This guide is designed specifically for **Tenant Owners** (business owners and managers) who are registering their store on the platform for the first time. It walks you through the signup process, details what is auto-initialized for your store behind the scenes, and outlines your Day 1 configuration tasks.
