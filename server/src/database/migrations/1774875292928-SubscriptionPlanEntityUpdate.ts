...
export class SubscriptionPlanEntityUpdate1774875292928 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "subscription_plans" ADD "monthly_price" numeric(10,2) NOT NULL DEFAULT '0'`,
    )
    await queryRunner.query(
      `ALTER TABLE "subscription_plans" ADD "yearly_price" numeric(10,2) NOT NULL DEFAULT '0'`,
    )
    await queryRunner.query(
      `ALTER TABLE "subscription_plans" ADD "is_popular" boolean NOT NULL DEFAULT false`,
    )
  }
