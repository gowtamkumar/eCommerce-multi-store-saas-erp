...
export class AllEnityAddedUserId1772892978314 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "page_traffic" ADD CONSTRAINT "FK_b2457320224276606ebc0023a52" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "page_traffic" DROP CONSTRAINT "FK_b2457320224276606ebc0023a52"`,
    )
    await queryRunner.query(
