...
export class PromotionEnityAdd1772767194741 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."promotions_promotiontype_enum" AS ENUM('percentage', 'fixed_amount', 'free_shipping', 'bogo')`);
        ...
        await queryRunner.query(`ALTER TABLE "promotions" ADD CONSTRAINT "FK_f8bcbc3a412f82f76f493769a98" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "promotions" DROP CONSTRAINT "FK_f8bcbc3a412f82f76f493769a98"`);
