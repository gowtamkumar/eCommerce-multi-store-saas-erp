...
export class CouponEntityAdd1772732454449 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "coupon_discount_amount" numeric(10,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "carts" ADD "applied_coupon_code" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "coupons" ADD CONSTRAINT "FK_169338eead44e81c390fbc64626" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "coupons" DROP CONSTRAINT "FK_169338eead44e81c390fbc64626"`);
