...
export class UpdateEnityType1772727662347 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "purchase_orders" ADD "payment_status" "public"."purchase_orders_payment_status_enum" NOT NULL DEFAULT 'PENDING'`,
    )
    await queryRunner.query(
      `ALTER TABLE "purchase_orders" ADD "paid_amount" numeric(10,2) NOT NULL DEFAULT '0'`,
    )
    await queryRunner.query(
