...
export class InitialBaseline1774867892750 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tenants_custom_domain_status_enum" AS ENUM('pending', 'verified', 'active')`);
        await queryRunner.query(`CREATE TYPE "public"."tenants_status_enum" AS ENUM('active', 'suspended', 'archived', 'expired')`);
        await queryRunner.query(`CREATE TYPE "public"."tenants_subscription_billing_cycle_enum" AS ENUM('monthly', 'yearly')`);
        await queryRunner.query(`CREATE TYPE "public"."tenants_subscription_status_enum" AS ENUM('active', 'past_due', 'canceled', 'expired')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'operator', 'user', 'super_admin', 'store_manager', 'support', 'marketing')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_52a29f8fc340e73d124af517f2" ON "users" ("username", "tenant_id") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscription_invoices_status_enum" AS ENUM('pending', 'paid', 'failed', 'completed')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_8b5bb3a42b7798ad7feff4e7d5" ON "pages" ("slug", "tenant_id") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_returns_status_enum" AS ENUM('pending', 'approved', 'rejected', 'refunded')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('pending', 'processing', 'shipped', 'completed', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "public"."orders_payment_method_enum" AS ENUM('cod', 'sslcommerz')`);
        await queryRunner.query(`CREATE TYPE "public"."orders_payment_status_enum" AS ENUM('pending', 'paid', 'failed', 'completed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_method_enum" AS ENUM('cod', 'sslcommerz')`);
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('pending', 'paid', 'failed', 'completed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."staff_invitations_role_enum" AS ENUM('admin', 'operator', 'user', 'super_admin', 'store_manager', 'support', 'marketing')`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" ADD CONSTRAINT "FK_84279188abf7dad6cb6fe2e3d9c" FOREIGN KEY ("subscription_plan_id") REFERENCES "subscription_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "subscription_invoices" ADD CONSTRAINT "FK_2a5257dfb60f446b19c287f416d" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "reviews" ADD CONSTRAINT "FK_bfb7f35d7db2b7afc40811c1925" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "faqs" ADD CONSTRAINT "FK_69e7c84542b637b399d0a88f9c6" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "brands" ADD CONSTRAINT "FK_33bb5b1b1a3a7e8b9787cd87784" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "categories" ADD CONSTRAINT "FK_5d4fe23b360b1b9e16a3f41727f" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_9c365ebf78f0e8a6d9e4827ea70" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "wishlists" ADD CONSTRAINT "FK_1a697e458e79055b7fc3ff0e8e0" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cart_items" ADD CONSTRAINT "FK_a1eb449d8def14d83cf82066f94" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "site_settings" ADD CONSTRAINT "FK_ae904a1632fb292b94b7c645715" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_items" ADD CONSTRAINT "FK_89dd5f9a3e63caf2e5f4ea85fac" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_returns" ADD CONSTRAINT "FK_c8fafcb69df5d7aaa71e26afe57" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "leads" ADD CONSTRAINT "FK_2440046dd05066e882bb68a780c" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_returns" DROP CONSTRAINT "FK_c8fafcb69df5d7aaa71e26afe57"`);
        ...
        await queryRunner.query(`ALTER TABLE "order_items" DROP CONSTRAINT "FK_89dd5f9a3e63caf2e5f4ea85fac"`);
        ...
        await queryRunner.query(`ALTER TABLE "site_settings" DROP CONSTRAINT "FK_ae904a1632fb292b94b7c645715"`);
        ...
        await queryRunner.query(`ALTER TABLE "cart_items" DROP CONSTRAINT "FK_a1eb449d8def14d83cf82066f94"`);
        ...
        await queryRunner.query(`ALTER TABLE "wishlists" DROP CONSTRAINT "FK_1a697e458e79055b7fc3ff0e8e0"`);
        ...
        await queryRunner.query(`ALTER TABLE "subscription_invoices" DROP CONSTRAINT "FK_2a5257dfb60f446b19c287f416d"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" DROP CONSTRAINT "FK_84279188abf7dad6cb6fe2e3d9c"`);
