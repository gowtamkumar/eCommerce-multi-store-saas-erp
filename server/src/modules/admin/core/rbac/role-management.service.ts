    ...
    const defaultRoleDefs: Array<{
    ...
    }> = [
      {
        ...
        permCodes: [
          ...
          'supplier:manage', 'supplier:view-pricing',
          // Sales & Orders
          'orders:read', 'orders:write', 'orders:cancel', 'orders:approve', 'orders:export',
          'returns:read', 'returns:write', 'returns:approve',
          // HRM (Operations)
          'hrm:clock-attendance', 'hrm:view-attendance-report', 'hrm:manage-employees',
          'hrm:approve-leave', 'hrm:manage-documents',
          // Finance & Accounting
          'finance:read-ledger', 'finance:write-expense',
          'accounting:read', 'accounting:write', 'invoices:manage',
          // Reporting
          'reports:read', 'reports:export', 'reports:schedule',
          // Team & CRM
          'users:read', 'users:invite',
          'crm:read', 'crm:write', 'crm:segment',
          // Logistics
          'fulfillment:manage',
          // Settings
          'settings:manage',
      ...
      },
      {
        ...
        permCodes: [
          ...
          'accounting:read', 'accounting:write', 'accounting:manage-coa',
          'invoices:manage', 'invoices:approve',
          'payments:read', 'payments:write', 'payments:reconcile',
          'reports:read', 'reports:view-financial', 'reports:export',
          'purchasing:read',
      ...
      },
      {
        ...
        permCodes: [
          ...
          'hrm:manage-employees', 'hrm:delete-employee', 'hrm:approve-leave', 'hrm:manage-documents',
          'users:read',
          'reports:read',
        ],
      },
      ...
      },
      {
        ...
        permCodes: [
          ...
          'reports:read',
          'fulfillment:manage',
          'logistics:manage', 'shipping:manage',
        ],
      },
      {
        name: 'Viewer',
