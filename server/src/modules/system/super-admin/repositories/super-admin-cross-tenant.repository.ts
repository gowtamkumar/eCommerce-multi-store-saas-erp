...
/**
 * Centralizes cross-tenant read access for Super Admin features. These queries
 * intentionally bypass tenant scoping and must only be reachable from
 * Super Admin guarded routes.
 */
@Injectable()
export class SuperAdminCrossTenantRepository {
