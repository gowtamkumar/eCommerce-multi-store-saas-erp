"use client";
import CourierSetting from "@/components/admin/setting/CourierSetting";
import CurrenciesSetting from "@/components/admin/setting/CurrenciesSetting";
import { DomainSetting } from "@/components/admin/setting/DomainSetting";
import { EmailSetting } from "@/components/admin/setting/EmailSetting";
import FooterSetting from "@/components/admin/setting/FooterSetting";
import GeneralSettings from "@/components/admin/setting/GeneralSettings";
import MarketingSetting from "@/components/admin/setting/MarketingSetting";
import NavbarSetting from "@/components/admin/setting/NavbarSetting";
import PaymentSetting from "@/components/admin/setting/PaymentSetting";
import SocialSetting from "@/components/admin/setting/SocialSetting";
import TrustDelivery from "@/components/admin/setting/Trust&Delivery";
...
function SettingsContent() {
    ...
    return (
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {/* Trust Badges Management Section */}
            {/* <TrustDelivery formData={formData} setFormData={setFormData} /> */}
        </div>
    );
}
