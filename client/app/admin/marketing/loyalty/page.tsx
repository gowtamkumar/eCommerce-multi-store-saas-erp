...
import { getLoyaltyConfig, updateLoyaltyConfig, manualCreditPoints, manualDebitPoints, getCustomerLoyaltyHistory, LoyaltyConfig, LoyaltyLedgerEntry } from "@/services/loyalty";
import { Award, Save, RefreshCw, Users, ShieldAlert, ArrowUpRight, ArrowDownRight, UserCheck } from "lucide-react";
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-6 border border-slate-200/50 dark:border-slate-850 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`w-14 h-8 rounded-full transition-colors relative flex items-center p-1 ${
                      config.isEnabled ? "bg-brand-600" : "bg-slate-350 dark:bg-slate-700"
                    }`}
                  >
                    <span className={`w-6 h-6 bg-white rounded-full shadow-sm transform transition-transform ${
