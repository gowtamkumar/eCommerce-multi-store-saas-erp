  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Store Notifications</h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Keep track of your store events, subscription activities, and system logs.</p>
        </div>
        {unreadCount > 0 && (
          <button
        ...
        <div className="p-8 border-b border-slate-100 dark:border-slate-700/50 space-y-6">
          <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white leading-none mb-1">Alert Hub</h2>
          ...
          {loading ? (
            ...
            <AnimatePresence mode="popLayout">
              {filteredNotifications.map((notif) => (
                ...
                >
                  {!notif.isRead && (
                    <span className="absolute top-7 left-3 w-2 h-2 rounded-full bg-indigo-600 shadow-md animate-pulse" />
                  )}
            ...
            <div className="py-32 text-center">
              <div className="flex flex-col items-center gap-3 opacity-35 max-w-sm mx-auto">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                  You are all caught up! When new system notifications arrive, they will show up here.
                </p>
              </div>
            </div>
          )}
