            ...
            `}>
                {image && (
                    <div className="flex-1 w-full md:w-auto flex justify-center">
                        <div className={`w-48 h-48 md:w-64 md:h-64 ${cardRadiusClass} overflow-hidden shadow-2xl border-4 border-white/20 shrink-0`}>
                ...
                `}>
                    <div className="space-y-4">
                        <h2
                            className="text-3xl md:text-5xl font-black uppercase tracking-tight drop-shadow-2xl"
                            style={{ color: styles?.headlineColor || (backgroundImage ? '#ffffff' : styles?.color) || 'inherit' }}
                        >
                            {headline || 'OFFER'}
                        </h2>
                        <p
                            className="font-bold uppercase tracking-widest text-sm md:text-lg opacity-90 drop-shadow-md"
                            style={{ color: styles?.sublineColor || (backgroundImage ? 'rgba(255, 255, 255, 0.9)' : styles?.color) || 'inherit' }}
                        >
                            {subline}
                        </p>
                    </div>
