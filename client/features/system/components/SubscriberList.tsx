...
import { Activity, Calendar, Database, Loader2, Mail, Search, Terminal } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Global Subscription Pulse</h1>
                ...
                <tr>
                  <td colSpan={3} className="px-8 py-32 text-center text-slate-500">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <p className="text-xs font-black uppercase tracking-widest text-slate-400">Syncing identity clusters...</p>
                    </div>
                  </td>
                </tr>
