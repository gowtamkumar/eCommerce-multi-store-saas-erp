...
export function SettingsLayout({ children }: { children: React.ReactNode }) {
    ...
    const tabConfigs: Record<TabType, { title: string; description: string; showSave?: boolean }> = {
        general: { title: "Store Settings", description: "Configure your brand identity and contact channels", showSave: true },
        ...
        marketing: { title: "SEO, Analytics & Social", description: "Manage SEO, robots.txt, analytics pixels, and social profiles", showSave: true },
        ...
        trust: { title: "Trust & Labels", description: "Manage trust badges, delivery highlights, and product labels", showSave: true },
