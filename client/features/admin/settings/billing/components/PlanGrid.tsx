  ...
  return (
    <section className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 px-4">
        ...
        <div className="bg-slate-100 dark:bg-slate-900/50 p-1 rounded-2xl flex gap-1 self-center sm:self-end font-display relative z-0 w-full sm:w-auto justify-center">
          <button
            onClick={() => setBillingCycle('monthly')}
            className={`px-4 sm:px-8 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all duration-300 relative flex-1 sm:flex-none ${
          ...
          <button
            ...
            className={`px-4 sm:px-8 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all duration-300 relative flex items-center justify-center gap-1.5 flex-1 sm:flex-none ${
              billingCycle === 'yearly'
                ? 'text-brand-600 dark:text-white font-black'
                : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'
            }`}
          >
            ...
            Yearly
            <span className={`text-[9px] px-2 py-0.5 rounded-full font-black normal-case shrink-0 ${
              billingCycle === 'yearly'
