...
export default function StockAdjustmentModal({ isOpen, onClose, onSuccess, initialProduct }: StockAdjustmentModalProps) {
                ...
                >
                                ...
                                <div className="space-y-6">
                                    ...
                                    {selectedProduct.variants && selectedProduct.variants.length > 0 && (
                                        <div className="space-y-3">
                                            <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Select Variant</label>
                                            ...
                                            <div className="flex p-1 bg-slate-100 dark:bg-slate-900 rounded-xl">
                                                <button
                                                    ...
                                                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg font-bold text-sm transition-all ${
                                                        type === 'IN' ? 'bg-white dark:bg-slate-800 text-emerald-600 shadow-sm' : 'text-slate-400 hover:text-slate-600'
                                                    }`}
                                                >
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => setType('OUT')}
                                                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg font-bold text-sm transition-all ${
                                                        type === 'OUT' ? 'bg-white dark:bg-slate-800 text-red-600 shadow-sm' : 'text-slate-400 hover:text-slate-600'
                                                    }`}
                                                >
                    ...
                    <div className="p-6 bg-slate-50/50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                        ...
                        <button 
                            ...
                            className="px-8 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-xl shadow-lg shadow-slate-900/10 hover:shadow-xl disabled:opacity-50 flex items-center gap-2 transition-all"
                        >
