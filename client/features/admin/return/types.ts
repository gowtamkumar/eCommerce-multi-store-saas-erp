...
export interface ReturnRequest {
    id: string;
    orderId: string;
    status: 'pending' | 'approved' | 'received' | 'rejected' | 'refunded' | 'exchanged' | 'cancelled';
...
export interface ReturnListProps {
    ...
    loading: boolean;
    onStatusUpdate: (id: string, status: string, comment?: string, refundMethod?: RefundMethod) => void;
}
