...
export function getCampaignSuccessRate(
  campaign: Pick<MarketingCampaign, "sentCount" | "failedCount">,
): number {
...
export function buildMarketingCsv(
  ...
  let csv =
    "TYPE,NAME/CODE,DETAILS,STATUS,REACH/LIMIT,SUCCESS/USED,FAILURES/UNUSED,SUCCESS RATE\n";
