                            ...
                            {loading ? (
                                ...
                                coupons.map((coupon) => (
                                    <tr key={coupon.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-700/50 transition-colors">
                                        <td className="p-4 cursor-pointer" onClick={() => onEdit(coupon)}>
                                        ...
                                        <td className="p-4 font-medium" onClick={() => onEdit(coupon)}>
                                        ...
                                        <td className="p-4 text-sm text-slate-600 dark:text-slate-300 cursor-pointer" onClick={() => onEdit(coupon)}>
