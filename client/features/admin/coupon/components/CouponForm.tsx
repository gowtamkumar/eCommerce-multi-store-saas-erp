...
import type { Coupon, CouponFormProps } from '../types';

export default function CouponForm({ initialData, onClose, onSuccess, isOpen }: CouponFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            startDate: formData.startDate ? new Date(formData.startDate as string).toISOString() : null,
            expiryDate: formData.expiryDate ? new Date(formData.expiryDate as string).toISOString() : null,
        };
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2 col-span-1 md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all text-sm outline-none"
                                    />
                                </div>
                            </div>
