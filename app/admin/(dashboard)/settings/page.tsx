...
type TabType = 'general' | 'domain' | 'email' | 'payment' | 'currencies' | 'social' | 'marketing' | 'navbar' | 'footer';
...
function SettingsContent() {
    ...
    useEffect(() => {
        ...
        if (tab && ['general', 'domain', 'email', 'payment', 'currencies', 'social', 'marketing', 'navbar', 'footer'].includes(tab)) {
            setActiveTab(tab);
        }
    }, [searchParams]);
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <h2 className="text-xl font-bold text-slate-900 dark:text-white">Footer Configuration</h2>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-slate-50 dark:bg-slate-900/40 rounded-3xl border border-slate-100 dark:border-slate-700/50">
                                            <div className="space-y-1.5">
                                                <label className="text-[12px] font-bold text-slate-500 uppercase">Footer Description</label>
                                                <textarea
                                            ...
                                            <div className="space-y-1.5">
                                                <label className="text-[12px] font-bold text-slate-500 uppercase">Copyright Text</label>
                                                <input
                                                    type="text"
                                                ...
                                                />
                                                <p className="text-[10px] text-slate-400 mt-1 italic">Include "Heart" keyword to keep the animated heart icon.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center justify-between">
                                                <h3 className="font-bold text-slate-800 dark:text-slate-200 uppercase text-xs tracking-wider">Footer Sections</h3>
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        setFormData({
                                                            ...
                                                            footerSections: [
                                                                ...
                                                                { title: '', order: formData.footerSections.length, links: [] }
                                                            ]
                                                        });
                                                    }}
                                            ...
                                            {formData.footerSections.length === 0 ? (
                                                <div className="text-center py-12 bg-slate-50/50 dark:bg-slate-900/20 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700">
                                                    ...
                                                    <p className="text-slate-500 font-medium">No footer sections configured</p>
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                                            setFormData({
                                                                ...formData,
                                                                footerDescription: 'Elevating your audio experience with premium sound and design.',
                                                                ...
                                                                footerSections: [
                                                                    {
                                                                        ...
                                                                        links: [
                                                                            ...
                                                                            { label: 'Headphones', href: '/products?category=headphones', order: 1, isOpenInNewTab: false, isActive: true },
                                                                            { label: 'Speakers', href: '/products?category=speakers', order: 2, isOpenInNewTab: false, isActive: true }
                                                                        ]
                                                                    },
                                                                    {
                                                                        title: 'Company',
                                                                        order: 1,
                                                                        links: [
                                                                            { label: 'About Us', href: '/', order: 0, isOpenInNewTab: false, isActive: true },
                                                                            { label: 'Contact', href: '/contact', order: 1, isOpenInNewTab: false, isActive: true },
                                                                            { label: 'Privacy Policy', href: '/privacy', order: 2, isOpenInNewTab: false, isActive: true }
                                                                        ]
                                                                    }
                                                                ]
                                                            });
                                                ...
                                                <div className="space-y-8">
                                                    {[...formData.footerSections].sort((a, b) => a.order - b.order).map((section, sIdx) => (
                                                        <div key={sIdx} className="bg-slate-50/50 dark:bg-slate-800/20 p-6 rounded-3xl border border-slate-200 dark:border-slate-700 relative group/section">
                                                            <button
                                                                type="button"
                                                                onClick={() => {
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-6">
                                                                ...
                                                                <div className="md:col-span-4 space-y-1">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        onChange={(e) => {
                                                                            const next = [...formData.footerSections];
                                                                            next[sIdx].order = parseInt(e.target.value) || 0;
                                                                            setFormData({ ...formData, footerSections: next });
                                                                        }}
                                                                        className="w-full bg-white dark:bg-slate-800 border dark:border-slate-700 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-brand-500 outline-none"
                                                                    />
                                                            ...
                                                            <div className="space-y-4 pl-4 border-l-2 border-slate-200 dark:border-slate-700 mt-4">
                                                                <div className="flex items-center justify-between mb-2">
                                                                    <span className="text-[10px] font-bold uppercase text-slate-500">Links in this section</span>
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => {
                                                                            const next = [...formData.footerSections];
                                                                            next[sIdx].links.push({ label: '', href: '', order: next[sIdx].links.length, isOpenInNewTab: false, isActive: true });
                                                                            setFormData({ ...formData, footerSections: next });
                                                                        }}
                                                                ...
                                                                <div className="grid gap-3">
                                                                    {section.links.sort((a, b) => a.order - b.order).map((link, lIdx) => (
                                                                        <div key={lIdx} className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end bg-white dark:bg-slate-900/40 p-3 rounded-xl border border-slate-100 dark:border-slate-700/50 group/link relative">
                                                                            <button
                                                                                type="button"
                                                                                onClick={() => {
                                                                                    const next = [...formData.footerSections];
                                                                                    next[sIdx].links = next[sIdx].links.filter((_, i) => i !== lIdx);
                                                                                    setFormData({ ...formData, footerSections: next });
                                                                                }}
                                                                            ...
                                                                            <div className="md:col-span-4 space-y-1">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    onChange={(e) => {
                                                                                        const next = [...formData.footerSections];
                                                                                        next[sIdx].links[lIdx].label = e.target.value;
                                                                                        setFormData({ ...formData, footerSections: next });
                                                                                    }}
                                                                            ...
                                                                            <div className="md:col-span-4 space-y-1">
                                                                                <label className="text-[9px] font-bold uppercase text-slate-400">URL</label>
                                                                                <input
                                                                                    type="text"
                                                                                    value={link.href}
                                                                                    onChange={(e) => {
                                                                                        const next = [...formData.footerSections];
                                                                                        next[sIdx].links[lIdx].href = e.target.value;
                                                                                        setFormData({ ...formData, footerSections: next });
                                                                                    }}
                                                                                    className="w-full bg-slate-50 dark:bg-slate-800/80 border-none rounded-lg px-2 py-1.5 text-[13px] outline-none"
                                                                                />
                                                                            ...
                                                                            <div className="md:col-span-2 space-y-1">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    onChange={(e) => {
                                                                                        const next = [...formData.footerSections];
                                                                                        next[sIdx].links[lIdx].order = parseInt(e.target.value) || 0;
                                                                                        setFormData({ ...formData, footerSections: next });
                                                                                    }}
                                                                                    className="w-full bg-slate-50 dark:bg-slate-800/80 border-none rounded-lg px-2 py-1.5 text-[13px] outline-none"
                                                                                />
                                                                            ...
                                                                            <div className="md:col-span-2 flex items-center justify-around pb-1.5">
                                                                                <div className="flex flex-col items-center gap-1">
                                                                                    <span className="text-[9px] font-bold uppercase text-slate-400">New Tab</span>
                                                                                    <input
                                                                                        type="checkbox"
                                                                                        checked={link.isOpenInNewTab}
                                                                                        onChange={(e) => {
                                                                                            const next = [...formData.footerSections];
                                                                                            next[sIdx].links[lIdx].isOpenInNewTab = e.target.checked;
                                                                                            setFormData({ ...formData, footerSections: next });
                                                                                        }}
                                                                                ...
                                                                                <div className="flex flex-col items-center gap-1">
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        onChange={(e) => {
                                                                                            const next = [...formData.footerSections];
                                                                                            next[sIdx].links[lIdx].isActive = e.target.checked;
                                                                                            setFormData({ ...formData, footerSections: next });
                                                                                        }}
                                                                                        className="w-3.5 h-3.5 text-brand-600 rounded"
                                                                                    />
