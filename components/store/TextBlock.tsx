...
export default function TextBlock({ alignment, html, headline, styles }: { alignment: string, html: string, headline: string, styles: any }) {
    return (
        <section style={styles} className={`px-4 md:px-10 py-16 md:py-24 flex ${alignment === 'left' ? 'justify-start text-left' : alignment === 'right' ? 'justify-end text-right' : 'justify-center text-center'}`}>
            <div className="max-w-3xl w-full mx-auto prose dark:prose-invert prose-brand lg:prose-2xl">
