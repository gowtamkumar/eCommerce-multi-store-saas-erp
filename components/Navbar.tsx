              ...
              <div className="py-2">
                ...
                {template.map((item) => (
                  <Link
                    ...
                    href={item.link}
                    onClick={closeMobileMenu}
                    className="block text-base font-medium text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800 px-4 py-3 rounded-lg transition-colors capitalize"
                  >
                    {item.name.replace(/-/g, ' ')}
                  </Link>
                ))}
